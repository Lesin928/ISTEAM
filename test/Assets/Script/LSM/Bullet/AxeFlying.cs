...
public class AxeFlying : MonoBehaviour
{
    public GameObject effect;
    private float force = 3f; //총알의 미는 힘 + 데미지 계수 
    ...
    {
        Debug.Log("Return");
        ObjectPoolManager.Instance.ReturnToPool("MedievalAxe", gameObject.GetComponent<AxeFlying>());// 총알 풀로 반환 
    }
